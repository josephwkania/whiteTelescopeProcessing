...
# Title: Headless Usrp Freqshift Giantpulse
# Generated: Tue Jun 26 05:33:57 2018
##################################################
...
class headless_usrp_freqshift_giantpulse(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Headless Usrp Freqshift Giantpulse")
...
def main(top_block_cls=headless_usrp_freqshift_giantpulse, options=None):
