...
# Title: Headless Airspy Freqshift
# Generated: Mon May 21 04:32:20 2018
##################################################
...
class headless_airspy_freqshift(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Headless Airspy Freqshift")
...
def main(top_block_cls=headless_airspy_freqshift, options=None):
