...
class obsHelper(object):
    ...
    def getUserData(self):
        ...
        print("You will need to make some choices about telescope configurations, this program "
        ...
        while True:
            try:
                coordSys = raw_input("Would you like to point the telescope using [ALTAZ, RADEC]? ")
            except ValueError:
