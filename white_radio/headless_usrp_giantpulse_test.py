...
# Title: Headless Usrp Giantpulse Test
# Generated: Mon Jul  2 02:45:03 2018
##################################################
...
class headless_usrp_giantpulse_test(gr.top_block):

    def __init__(self, freq=0):
        gr.top_block.__init__(self, "Headless Usrp Giantpulse Test")
        ...
        self.giantout = giantout = "/home/dspradio/giantPulses/" + timenow + "_Drift.h5"
        ...
        self.radio_astro_hdf5_sink_0 = radio_astro.hdf5_sink(vec_length, giantout, 'alt=72,az=180', 0, 1, 'This is integrated spectra ~1ms cadence')
    ...
    def set_timenow(self, timenow):
        ...
        self.set_giantout("/home/dspradio/giantPulses/" + self.timenow + "_Drift.h5")
...
def argument_parser():
    ...
    parser.add_option(
        "", "--freq", dest="freq", type="eng_float", default=eng_notation.num_to_str(0),
        help="Set freq [default=%default]")
    return parser


def main(top_block_cls=headless_usrp_giantpulse_test, options=None):
    if options is None:
