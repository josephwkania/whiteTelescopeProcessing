...
class headless_usrp_freqshift(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Headless Usrp Freqshift")
...
def main(top_block_cls=headless_usrp_freqshift, options=None):
